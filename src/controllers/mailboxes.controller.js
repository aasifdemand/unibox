    ...
    ...gmailSenders.map(async (s) => {
      ...
      return {
        ...
        stats: {
          ...
          warmupInitialLimit: s.warmupInitialLimit,
          warmupIncrementBy: s.warmupIncrementBy,
          warmupMaxLimit: s.warmupMaxLimit,
          warmupDailyLimit: s.warmupDailyLimit,
          warmupCurrentSent: s.warmupCurrentSent,
        },
      };
    }),
